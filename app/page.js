...
<section className=' px-[2em] gap-[5em] flex-col md:flex-row   justify-center items-center  lg:px-[10em] mt-[5em] flex w-full'>
    ...
    <div className=' flex justify-center items-center flex-col gap-4'>
     ...
     <section className=' px-[0em] lg:px-[10em] mt-[5em] w-full'>
      ...
      <div className=' w-fit  '>
            <img src="/environment.jpeg" className='  rounded-lg max-h-[15em]  h-[15em] w-[20em] max-w-[20em] ' alt="" />
            <p className=' px-2 font-semibold text-center w-full py-4'> Conducive environment</p>
          </div>
          <div className='  w-fit'>
            <img src="/classRoom.jpeg" className=' rounded-lg max-h-[15em] h-[15em] w-[20em] max-w-[20em] ' alt="" />
            <p className=' px-2 font-semibold text-center w-full py-4'> Good Learning environronment <br /> / Class Room</p>
          </div>
         
          <div className='  w-fit'>
            <img src="/bus.jpeg" className=' rounded-lg max-h-[15em] h-[15em] w-[20em] max-w-[20em] ' alt="" />
            <p className=' mx-auto font-semibold text-center w-full py-4'> Bus services</p>
          </div>
          <div className='  w-fit'>
            <img src="/ict.jpeg" className=' rounded-lg max-h-[15em] h-[15em] w-[20em] max-w-[20em] ' alt="" />
            <p className=' mx-auto font-semibold text-center w-full py-4'> Well equipped Ict Lab</p>
          </div>
          <div className='  w-fit'>
            <img src="/building.jpeg" className=' rounded-lg max-h-[15em] h-[15em] w-[20em] max-w-[20em] ' alt="" />
